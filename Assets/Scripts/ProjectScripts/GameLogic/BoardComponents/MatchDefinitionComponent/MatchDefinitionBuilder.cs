...
#region Character Pieces
        ...
        dict.Add(PieceType.NPC_C5.Id, new PieceMatchDef {Next = PieceType.NPC_C.Id, Previous = PieceType.NPC_C4.Id, Amount = 3});
...
//        dict.Add(PieceType.NPC_C8.Id, new PieceMatchDef {Next = PieceType.NPC_C.Id, Previous = PieceType.NPC_C7.Id, Amount = 3});
        dict.Add(PieceType.NPC_C.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_C5.Id, Amount = -1});
        ...
        dict.Add(PieceType.NPC_D6.Id, new PieceMatchDef {Next = PieceType.NPC_D.Id, Previous = PieceType.NPC_D5.Id, Amount = 3});
...
//        dict.Add(PieceType.NPC_D8.Id, new PieceMatchDef {Next = PieceType.NPC_D.Id, Previous = PieceType.NPC_D7.Id, Amount = 3});
        dict.Add(PieceType.NPC_D.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_D6.Id, Amount = -1});
        ...
        dict.Add(PieceType.NPC_G6.Id, new PieceMatchDef {Next = PieceType.NPC_G7.Id, Previous = PieceType.NPC_G5.Id, Amount = 3});
        dict.Add(PieceType.NPC_G7.Id, new PieceMatchDef {Next = PieceType.NPC_G8.Id, Previous = PieceType.NPC_G6.Id, Amount = 3});
        dict.Add(PieceType.NPC_G8.Id, new PieceMatchDef {Next = PieceType.NPC_G.Id, Previous = PieceType.NPC_G7.Id, Amount = 3});
        dict.Add(PieceType.NPC_G.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_G8.Id, Amount = -1});
        
        #endregion
        
        #region NPC_H
        
        dict.Add(PieceType.NPC_H1.Id, new PieceMatchDef {Next = PieceType.NPC_H2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_H2.Id, new PieceMatchDef {Next = PieceType.NPC_H3.Id, Previous = PieceType.NPC_H1.Id, Amount = 3});
        dict.Add(PieceType.NPC_H3.Id, new PieceMatchDef {Next = PieceType.NPC_H4.Id, Previous = PieceType.NPC_H2.Id, Amount = 3});
        dict.Add(PieceType.NPC_H4.Id, new PieceMatchDef {Next = PieceType.NPC_H5.Id, Previous = PieceType.NPC_H3.Id, Amount = 3});
        dict.Add(PieceType.NPC_H5.Id, new PieceMatchDef {Next = PieceType.NPC_H6.Id, Previous = PieceType.NPC_H4.Id, Amount = 3});
        dict.Add(PieceType.NPC_H6.Id, new PieceMatchDef {Next = PieceType.NPC_H7.Id, Previous = PieceType.NPC_H5.Id, Amount = 3});
        dict.Add(PieceType.NPC_H7.Id, new PieceMatchDef {Next = PieceType.NPC_H8.Id, Previous = PieceType.NPC_H6.Id, Amount = 3});
        dict.Add(PieceType.NPC_H8.Id, new PieceMatchDef {Next = PieceType.NPC_H.Id, Previous = PieceType.NPC_H7.Id, Amount = 3});
        dict.Add(PieceType.NPC_H.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_H8.Id, Amount = -1});
        
        #endregion
        
        #region NPC_I
        
        dict.Add(PieceType.NPC_I1.Id, new PieceMatchDef {Next = PieceType.NPC_I2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_I2.Id, new PieceMatchDef {Next = PieceType.NPC_I3.Id, Previous = PieceType.NPC_I1.Id, Amount = 3});
        dict.Add(PieceType.NPC_I3.Id, new PieceMatchDef {Next = PieceType.NPC_I4.Id, Previous = PieceType.NPC_I2.Id, Amount = 3});
        dict.Add(PieceType.NPC_I4.Id, new PieceMatchDef {Next = PieceType.NPC_I5.Id, Previous = PieceType.NPC_I3.Id, Amount = 3});
        dict.Add(PieceType.NPC_I5.Id, new PieceMatchDef {Next = PieceType.NPC_I6.Id, Previous = PieceType.NPC_I4.Id, Amount = 3});
        dict.Add(PieceType.NPC_I6.Id, new PieceMatchDef {Next = PieceType.NPC_I7.Id, Previous = PieceType.NPC_I5.Id, Amount = 3});
        dict.Add(PieceType.NPC_I7.Id, new PieceMatchDef {Next = PieceType.NPC_I8.Id, Previous = PieceType.NPC_I6.Id, Amount = 3});
        dict.Add(PieceType.NPC_I8.Id, new PieceMatchDef {Next = PieceType.NPC_I.Id, Previous = PieceType.NPC_I7.Id, Amount = 3});
        dict.Add(PieceType.NPC_I.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_I8.Id, Amount = -1});
        
        #endregion
        
        #region NPC_J
        
        dict.Add(PieceType.NPC_J1.Id, new PieceMatchDef {Next = PieceType.NPC_J2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_J2.Id, new PieceMatchDef {Next = PieceType.NPC_J3.Id, Previous = PieceType.NPC_J1.Id, Amount = 3});
        dict.Add(PieceType.NPC_J3.Id, new PieceMatchDef {Next = PieceType.NPC_J4.Id, Previous = PieceType.NPC_J2.Id, Amount = 3});
        dict.Add(PieceType.NPC_J4.Id, new PieceMatchDef {Next = PieceType.NPC_J5.Id, Previous = PieceType.NPC_J3.Id, Amount = 3});
        dict.Add(PieceType.NPC_J5.Id, new PieceMatchDef {Next = PieceType.NPC_J6.Id, Previous = PieceType.NPC_J4.Id, Amount = 3});
        dict.Add(PieceType.NPC_J6.Id, new PieceMatchDef {Next = PieceType.NPC_J.Id, Previous = PieceType.NPC_J5.Id, Amount = 3});
        dict.Add(PieceType.NPC_J.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_J6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_K
        
        dict.Add(PieceType.NPC_K1.Id, new PieceMatchDef {Next = PieceType.NPC_K2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_K2.Id, new PieceMatchDef {Next = PieceType.NPC_K3.Id, Previous = PieceType.NPC_K1.Id, Amount = 3});
        dict.Add(PieceType.NPC_K3.Id, new PieceMatchDef {Next = PieceType.NPC_K4.Id, Previous = PieceType.NPC_K2.Id, Amount = 3});
        dict.Add(PieceType.NPC_K4.Id, new PieceMatchDef {Next = PieceType.NPC_K5.Id, Previous = PieceType.NPC_K3.Id, Amount = 3});
        dict.Add(PieceType.NPC_K5.Id, new PieceMatchDef {Next = PieceType.NPC_K6.Id, Previous = PieceType.NPC_K4.Id, Amount = 3});
        dict.Add(PieceType.NPC_K6.Id, new PieceMatchDef {Next = PieceType.NPC_K.Id, Previous = PieceType.NPC_K5.Id, Amount = 3});
        dict.Add(PieceType.NPC_K.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_K6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_L
        
        dict.Add(PieceType.NPC_L1.Id, new PieceMatchDef {Next = PieceType.NPC_L2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_L2.Id, new PieceMatchDef {Next = PieceType.NPC_L3.Id, Previous = PieceType.NPC_L1.Id, Amount = 3});
        dict.Add(PieceType.NPC_L3.Id, new PieceMatchDef {Next = PieceType.NPC_L4.Id, Previous = PieceType.NPC_L2.Id, Amount = 3});
        dict.Add(PieceType.NPC_L4.Id, new PieceMatchDef {Next = PieceType.NPC_L5.Id, Previous = PieceType.NPC_L3.Id, Amount = 3});
        dict.Add(PieceType.NPC_L5.Id, new PieceMatchDef {Next = PieceType.NPC_L6.Id, Previous = PieceType.NPC_L4.Id, Amount = 3});
        dict.Add(PieceType.NPC_L6.Id, new PieceMatchDef {Next = PieceType.NPC_L.Id, Previous = PieceType.NPC_L5.Id, Amount = 3});
        dict.Add(PieceType.NPC_L.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_L6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_M
        
        dict.Add(PieceType.NPC_M1.Id, new PieceMatchDef {Next = PieceType.NPC_M2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_M2.Id, new PieceMatchDef {Next = PieceType.NPC_M3.Id, Previous = PieceType.NPC_M1.Id, Amount = 3});
        dict.Add(PieceType.NPC_M3.Id, new PieceMatchDef {Next = PieceType.NPC_M4.Id, Previous = PieceType.NPC_M2.Id, Amount = 3});
        dict.Add(PieceType.NPC_M4.Id, new PieceMatchDef {Next = PieceType.NPC_M5.Id, Previous = PieceType.NPC_M3.Id, Amount = 3});
        dict.Add(PieceType.NPC_M5.Id, new PieceMatchDef {Next = PieceType.NPC_M6.Id, Previous = PieceType.NPC_M4.Id, Amount = 3});
        dict.Add(PieceType.NPC_M6.Id, new PieceMatchDef {Next = PieceType.NPC_M.Id, Previous = PieceType.NPC_M5.Id, Amount = 3});
        dict.Add(PieceType.NPC_M.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_M6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_N
        
        dict.Add(PieceType.NPC_N1.Id, new PieceMatchDef {Next = PieceType.NPC_N2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_N2.Id, new PieceMatchDef {Next = PieceType.NPC_N3.Id, Previous = PieceType.NPC_N1.Id, Amount = 3});
        dict.Add(PieceType.NPC_N3.Id, new PieceMatchDef {Next = PieceType.NPC_N4.Id, Previous = PieceType.NPC_N2.Id, Amount = 3});
        dict.Add(PieceType.NPC_N4.Id, new PieceMatchDef {Next = PieceType.NPC_N5.Id, Previous = PieceType.NPC_N3.Id, Amount = 3});
        dict.Add(PieceType.NPC_N5.Id, new PieceMatchDef {Next = PieceType.NPC_N6.Id, Previous = PieceType.NPC_N4.Id, Amount = 3});
        dict.Add(PieceType.NPC_N6.Id, new PieceMatchDef {Next = PieceType.NPC_N.Id, Previous = PieceType.NPC_N5.Id, Amount = 3});
        dict.Add(PieceType.NPC_N.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_N6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_O
        
        dict.Add(PieceType.NPC_O1.Id, new PieceMatchDef {Next = PieceType.NPC_O2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_O2.Id, new PieceMatchDef {Next = PieceType.NPC_O3.Id, Previous = PieceType.NPC_O1.Id, Amount = 3});
        dict.Add(PieceType.NPC_O3.Id, new PieceMatchDef {Next = PieceType.NPC_O4.Id, Previous = PieceType.NPC_O2.Id, Amount = 3});
        dict.Add(PieceType.NPC_O4.Id, new PieceMatchDef {Next = PieceType.NPC_O5.Id, Previous = PieceType.NPC_O3.Id, Amount = 3});
        dict.Add(PieceType.NPC_O5.Id, new PieceMatchDef {Next = PieceType.NPC_O6.Id, Previous = PieceType.NPC_O4.Id, Amount = 3});
        dict.Add(PieceType.NPC_O6.Id, new PieceMatchDef {Next = PieceType.NPC_O.Id, Previous = PieceType.NPC_O5.Id, Amount = 3});
        dict.Add(PieceType.NPC_O.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_O6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_P
        
        dict.Add(PieceType.NPC_P1.Id, new PieceMatchDef {Next = PieceType.NPC_P2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_P2.Id, new PieceMatchDef {Next = PieceType.NPC_P3.Id, Previous = PieceType.NPC_P1.Id, Amount = 3});
        dict.Add(PieceType.NPC_P3.Id, new PieceMatchDef {Next = PieceType.NPC_P4.Id, Previous = PieceType.NPC_P2.Id, Amount = 3});
        dict.Add(PieceType.NPC_P4.Id, new PieceMatchDef {Next = PieceType.NPC_P5.Id, Previous = PieceType.NPC_P3.Id, Amount = 3});
        dict.Add(PieceType.NPC_P5.Id, new PieceMatchDef {Next = PieceType.NPC_P6.Id, Previous = PieceType.NPC_P4.Id, Amount = 3});
        dict.Add(PieceType.NPC_P6.Id, new PieceMatchDef {Next = PieceType.NPC_P.Id, Previous = PieceType.NPC_P5.Id, Amount = 3});
        dict.Add(PieceType.NPC_P.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_P6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_Q
        
        dict.Add(PieceType.NPC_Q1.Id, new PieceMatchDef {Next = PieceType.NPC_Q2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_Q2.Id, new PieceMatchDef {Next = PieceType.NPC_Q3.Id, Previous = PieceType.NPC_Q1.Id, Amount = 3});
        dict.Add(PieceType.NPC_Q3.Id, new PieceMatchDef {Next = PieceType.NPC_Q4.Id, Previous = PieceType.NPC_Q2.Id, Amount = 3});
        dict.Add(PieceType.NPC_Q4.Id, new PieceMatchDef {Next = PieceType.NPC_Q5.Id, Previous = PieceType.NPC_Q3.Id, Amount = 3});
        dict.Add(PieceType.NPC_Q5.Id, new PieceMatchDef {Next = PieceType.NPC_Q6.Id, Previous = PieceType.NPC_Q4.Id, Amount = 3});
        dict.Add(PieceType.NPC_Q6.Id, new PieceMatchDef {Next = PieceType.NPC_Q.Id, Previous = PieceType.NPC_Q5.Id, Amount = 3});
        dict.Add(PieceType.NPC_Q.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_Q6.Id, Amount = -1});
        
        #endregion
        
        #region NPC_R
        
        dict.Add(PieceType.NPC_R1.Id, new PieceMatchDef {Next = PieceType.NPC_R2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.NPC_R2.Id, new PieceMatchDef {Next = PieceType.NPC_R3.Id, Previous = PieceType.NPC_R1.Id, Amount = 3});
        dict.Add(PieceType.NPC_R3.Id, new PieceMatchDef {Next = PieceType.NPC_R4.Id, Previous = PieceType.NPC_R2.Id, Amount = 3});
        dict.Add(PieceType.NPC_R4.Id, new PieceMatchDef {Next = PieceType.NPC_R5.Id, Previous = PieceType.NPC_R3.Id, Amount = 3});
        dict.Add(PieceType.NPC_R5.Id, new PieceMatchDef {Next = PieceType.NPC_R6.Id, Previous = PieceType.NPC_R4.Id, Amount = 3});
        dict.Add(PieceType.NPC_R6.Id, new PieceMatchDef {Next = PieceType.NPC_R.Id, Previous = PieceType.NPC_R5.Id, Amount = 3});
        dict.Add(PieceType.NPC_R.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.NPC_R6.Id, Amount = -1});
...
#region Obstacles
        ...
        dict.Add(PieceType.OB4_G.Id, new PieceMatchDef {Next = PieceType.OB5_G.Id, Previous = PieceType.OB3_G.Id, Amount = -1});
        dict.Add(PieceType.OB5_G.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.OB4_G.Id, Amount = -1});
...
#region Mine
        ...
        dict.Add(PieceType.MN_B1.Id,     new PieceMatchDef {Next = PieceType.MN_B2Fake.Id, Previous = PieceType.MN_B.Id,  Amount = 1});
        dict.Add(PieceType.MN_B2Fake.Id, new PieceMatchDef {Next = PieceType.MN_B2.Id,     Previous = PieceType.MN_B1.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_B2.Id,     new PieceMatchDef {Next = PieceType.MN_B3Fake.Id, Previous = PieceType.MN_B1.Id, Amount = 1});
        dict.Add(PieceType.MN_B3Fake.Id, new PieceMatchDef {Next = PieceType.MN_B3.Id,     Previous = PieceType.MN_B2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_B3.Id,     new PieceMatchDef {Next = PieceType.MN_B4Fake.Id, Previous = PieceType.MN_B2.Id, Amount = 1});
        dict.Add(PieceType.MN_B4Fake.Id, new PieceMatchDef {Next = PieceType.MN_B3.Id,     Previous = PieceType.MN_B3.Id, Amount = 1, IsIgnore = true});
        
        #endregion
        
        #region MN_C
        
        dict.Add(PieceType.MN_C.Id,      new PieceMatchDef {Next = PieceType.MN_C1.Id,     Previous = PieceType.None.Id,  Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_C1.Id,     new PieceMatchDef {Next = PieceType.MN_C2Fake.Id, Previous = PieceType.MN_C.Id,  Amount = 1});
        dict.Add(PieceType.MN_C2Fake.Id, new PieceMatchDef {Next = PieceType.MN_C2.Id,     Previous = PieceType.MN_C1.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_C2.Id,     new PieceMatchDef {Next = PieceType.MN_C3Fake.Id, Previous = PieceType.MN_C1.Id, Amount = 1});
        dict.Add(PieceType.MN_C3Fake.Id, new PieceMatchDef {Next = PieceType.MN_C3.Id,     Previous = PieceType.MN_C2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_C3.Id,     new PieceMatchDef {Next = PieceType.MN_C4Fake.Id, Previous = PieceType.MN_C2.Id, Amount = 1});
        dict.Add(PieceType.MN_C4Fake.Id, new PieceMatchDef {Next = PieceType.MN_C3.Id,     Previous = PieceType.MN_C3.Id, Amount = 1, IsIgnore = true});
        ...
        dict.Add(PieceType.MN_E1.Id,     new PieceMatchDef {Next = PieceType.MN_E2Fake.Id, Previous = PieceType.MN_E.Id,  Amount = 1});
        dict.Add(PieceType.MN_E2Fake.Id, new PieceMatchDef {Next = PieceType.MN_E2.Id,     Previous = PieceType.MN_E1.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_E2.Id,     new PieceMatchDef {Next = PieceType.MN_E3Fake.Id, Previous = PieceType.MN_E1.Id, Amount = 1});
        dict.Add(PieceType.MN_E3Fake.Id, new PieceMatchDef {Next = PieceType.MN_E3.Id,     Previous = PieceType.MN_E2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_E3.Id,     new PieceMatchDef {Next = PieceType.MN_E4Fake.Id, Previous = PieceType.MN_E2.Id, Amount = 1});
        dict.Add(PieceType.MN_E4Fake.Id, new PieceMatchDef {Next = PieceType.MN_E3.Id,     Previous = PieceType.MN_E3.Id, Amount = 1, IsIgnore = true});
        
        #endregion
        
        #region MN_F
        
        dict.Add(PieceType.MN_F.Id,      new PieceMatchDef {Next = PieceType.MN_F1.Id,     Previous = PieceType.None.Id,  Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_F1.Id,     new PieceMatchDef {Next = PieceType.MN_F2Fake.Id, Previous = PieceType.MN_F.Id,  Amount = 1});
        dict.Add(PieceType.MN_F2Fake.Id, new PieceMatchDef {Next = PieceType.MN_F2.Id,     Previous = PieceType.MN_F1.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_F2.Id,     new PieceMatchDef {Next = PieceType.MN_F3Fake.Id, Previous = PieceType.MN_F1.Id, Amount = 1});
        dict.Add(PieceType.MN_F3Fake.Id, new PieceMatchDef {Next = PieceType.MN_F3.Id,     Previous = PieceType.MN_F2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_F3.Id,     new PieceMatchDef {Next = PieceType.MN_F4Fake.Id, Previous = PieceType.MN_F2.Id, Amount = 1});
        ...
        dict.Add(PieceType.MN_H.Id,      new PieceMatchDef {Next = PieceType.MN_H1.Id,     Previous = PieceType.None.Id,  Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_H1.Id,     new PieceMatchDef {Next = PieceType.MN_H2Fake.Id, Previous = PieceType.MN_H.Id,  Amount = 1});
        dict.Add(PieceType.MN_H2Fake.Id, new PieceMatchDef {Next = PieceType.MN_H2.Id,     Previous = PieceType.MN_H1.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_H2.Id,     new PieceMatchDef {Next = PieceType.MN_H3Fake.Id, Previous = PieceType.MN_H1.Id, Amount = 1});
        dict.Add(PieceType.MN_H3Fake.Id, new PieceMatchDef {Next = PieceType.MN_H3.Id,     Previous = PieceType.MN_H2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_H3.Id,     new PieceMatchDef {Next = PieceType.MN_H4Fake.Id, Previous = PieceType.MN_H2.Id, Amount = 1});
        dict.Add(PieceType.MN_H4Fake.Id, new PieceMatchDef {Next = PieceType.MN_H3.Id,     Previous = PieceType.MN_H3.Id, Amount = 1, IsIgnore = true});
        
        #endregion
        
        #region MN_I
        
        dict.Add(PieceType.MN_I.Id,      new PieceMatchDef {Next = PieceType.MN_I1.Id,     Previous = PieceType.None.Id,  Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_I1.Id,     new PieceMatchDef {Next = PieceType.MN_I2Fake.Id, Previous = PieceType.MN_I.Id,  Amount = 1});
        dict.Add(PieceType.MN_I2Fake.Id, new PieceMatchDef {Next = PieceType.MN_I2.Id,     Previous = PieceType.MN_I1.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_I2.Id,     new PieceMatchDef {Next = PieceType.MN_I3Fake.Id, Previous = PieceType.MN_I1.Id, Amount = 1});
        dict.Add(PieceType.MN_I3Fake.Id, new PieceMatchDef {Next = PieceType.MN_I3.Id,     Previous = PieceType.MN_I2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.MN_I3.Id,     new PieceMatchDef {Next = PieceType.MN_I4Fake.Id, Previous = PieceType.MN_I2.Id, Amount = 1});
        dict.Add(PieceType.MN_I4Fake.Id, new PieceMatchDef {Next = PieceType.MN_I3.Id,     Previous = PieceType.MN_I3.Id, Amount = 1, IsIgnore = true});
...
#region Simple Pieces
        ...
        dict.Add(PieceType.A8.Id, new PieceMatchDef {Next = PieceType.AMFake.Id, Previous = PieceType.A7.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.AMFake.Id, PieceType.AM.Id, PieceType.A8.Id);
        
        dict.Add(PieceType.AM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.A8.Id});
        ...
        dict.Add(PieceType.B9.Id, new PieceMatchDef {Next = PieceType.BMFake.Id, Previous = PieceType.B8.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.BMFake.Id, PieceType.BM.Id, PieceType.B9.Id);
        
        dict.Add(PieceType.BM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.B9.Id});
        ...
        dict.Add(PieceType.C9.Id, new PieceMatchDef {Next = PieceType.CMFake.Id, Previous = PieceType.C8.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.CMFake.Id, PieceType.CM.Id, PieceType.C9.Id);
        
        dict.Add(PieceType.CM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.C9.Id});
        ...
        dict.Add(PieceType.E9.Id,     new PieceMatchDef {Next = PieceType.EMFake.Id, Previous = PieceType.E8.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.EMFake.Id, PieceType.EM.Id, PieceType.E9.Id);
        
        dict.Add(PieceType.EM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.E9.Id});
...
#region Extended Pieces
        ...
        dict.Add(PieceType.EXT_A1.Id, new PieceMatchDef {Next = PieceType.EXT_A2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.EXT_A2.Id, new PieceMatchDef {Next = PieceType.EXT_A3Fake.Id, Previous = PieceType.EXT_A1.Id, Amount = 3});
        dict.Add(PieceType.EXT_A3Fake.Id, new PieceMatchDef {Next = PieceType.EXT_A3.Id, Previous = PieceType.EXT_A2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_A3.Id, new PieceMatchDef {Next = PieceType.EXT_A4Fake.Id, Previous = PieceType.EXT_A2.Id, Amount = 3});
        dict.Add(PieceType.EXT_A4Fake.Id, new PieceMatchDef {Next = PieceType.EXT_A4.Id, Previous = PieceType.EXT_A3.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_A4.Id, new PieceMatchDef {Next = PieceType.EXT_A5Fake.Id, Previous = PieceType.EXT_A3.Id, Amount = 3});
        dict.Add(PieceType.EXT_A5Fake.Id, new PieceMatchDef {Next = PieceType.EXT_A5.Id, Previous = PieceType.EXT_A4.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_A5.Id, new PieceMatchDef {Next = PieceType.EXT_A6Fake.Id, Previous = PieceType.EXT_A4.Id, Amount = 3});
        dict.Add(PieceType.EXT_A6Fake.Id, new PieceMatchDef {Next = PieceType.EXT_A6.Id, Previous = PieceType.EXT_A5.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_A6.Id, new PieceMatchDef {Next = PieceType.EXT_A7Fake.Id, Previous = PieceType.EXT_A5.Id, Amount = 3});
        dict.Add(PieceType.EXT_A7Fake.Id, new PieceMatchDef {Next = PieceType.EXT_A7.Id, Previous = PieceType.EXT_A6.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_A7.Id, new PieceMatchDef {Next = PieceType.EXT_A8Fake.Id, Previous = PieceType.EXT_A6.Id, Amount = 3});
        dict.Add(PieceType.EXT_A8Fake.Id, new PieceMatchDef {Next = PieceType.EXT_A8.Id, Previous = PieceType.EXT_A7.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_A8.Id, new PieceMatchDef {Next = PieceType.EXT_AMFake.Id, Previous = PieceType.EXT_A7.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.EXT_AMFake.Id, PieceType.EXT_AM.Id, PieceType.EXT_A8.Id);
        
        dict.Add(PieceType.EXT_AM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.EXT_A8.Id});
        
        #endregion
        
        #region EXT_B
        
        dict.Add(PieceType.EXT_B1.Id, new PieceMatchDef {Next = PieceType.EXT_B2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.EXT_B2.Id, new PieceMatchDef {Next = PieceType.EXT_B3Fake.Id, Previous = PieceType.EXT_B1.Id, Amount = 3});
        dict.Add(PieceType.EXT_B3Fake.Id, new PieceMatchDef {Next = PieceType.EXT_B3.Id, Previous = PieceType.EXT_B2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_B3.Id, new PieceMatchDef {Next = PieceType.EXT_B4Fake.Id, Previous = PieceType.EXT_B2.Id, Amount = 3});
        dict.Add(PieceType.EXT_B4Fake.Id, new PieceMatchDef {Next = PieceType.EXT_B4.Id, Previous = PieceType.EXT_B3.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_B4.Id, new PieceMatchDef {Next = PieceType.EXT_B5Fake.Id, Previous = PieceType.EXT_B3.Id, Amount = 3});
        dict.Add(PieceType.EXT_B5Fake.Id, new PieceMatchDef {Next = PieceType.EXT_B5.Id, Previous = PieceType.EXT_B4.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_B5.Id, new PieceMatchDef {Next = PieceType.EXT_B6Fake.Id, Previous = PieceType.EXT_B4.Id, Amount = 3});
        dict.Add(PieceType.EXT_B6Fake.Id, new PieceMatchDef {Next = PieceType.EXT_B6.Id, Previous = PieceType.EXT_B5.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_B6.Id, new PieceMatchDef {Next = PieceType.EXT_B7Fake.Id, Previous = PieceType.EXT_B5.Id, Amount = 3});
        dict.Add(PieceType.EXT_B7Fake.Id, new PieceMatchDef {Next = PieceType.EXT_B7.Id, Previous = PieceType.EXT_B6.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_B7.Id, new PieceMatchDef {Next = PieceType.EXT_B8Fake.Id, Previous = PieceType.EXT_B6.Id, Amount = 3});
        dict.Add(PieceType.EXT_B8Fake.Id, new PieceMatchDef {Next = PieceType.EXT_B8.Id, Previous = PieceType.EXT_B7.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_B8.Id, new PieceMatchDef {Next = PieceType.EXT_BMFake.Id, Previous = PieceType.EXT_B7.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.EXT_BMFake.Id, PieceType.EXT_BM.Id, PieceType.EXT_B8.Id);
        
        dict.Add(PieceType.EXT_BM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.EXT_B8.Id});
        
        #endregion
        
        #region EXT_C
        
        dict.Add(PieceType.EXT_C1.Id, new PieceMatchDef {Next = PieceType.EXT_C2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.EXT_C2.Id, new PieceMatchDef {Next = PieceType.EXT_C3Fake.Id, Previous = PieceType.EXT_C1.Id, Amount = 3});
        dict.Add(PieceType.EXT_C3Fake.Id, new PieceMatchDef {Next = PieceType.EXT_C3.Id, Previous = PieceType.EXT_C2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_C3.Id, new PieceMatchDef {Next = PieceType.EXT_C4Fake.Id, Previous = PieceType.EXT_C2.Id, Amount = 3});
        dict.Add(PieceType.EXT_C4Fake.Id, new PieceMatchDef {Next = PieceType.EXT_C4.Id, Previous = PieceType.EXT_C3.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_C4.Id, new PieceMatchDef {Next = PieceType.EXT_C5Fake.Id, Previous = PieceType.EXT_C3.Id, Amount = 3});
        dict.Add(PieceType.EXT_C5Fake.Id, new PieceMatchDef {Next = PieceType.EXT_C5.Id, Previous = PieceType.EXT_C4.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_C5.Id, new PieceMatchDef {Next = PieceType.EXT_C6Fake.Id, Previous = PieceType.EXT_C4.Id, Amount = 3});
        dict.Add(PieceType.EXT_C6Fake.Id, new PieceMatchDef {Next = PieceType.EXT_C6.Id, Previous = PieceType.EXT_C5.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_C6.Id, new PieceMatchDef {Next = PieceType.EXT_C7Fake.Id, Previous = PieceType.EXT_C5.Id, Amount = 3});
        dict.Add(PieceType.EXT_C7Fake.Id, new PieceMatchDef {Next = PieceType.EXT_C7.Id, Previous = PieceType.EXT_C6.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_C7.Id, new PieceMatchDef {Next = PieceType.EXT_C8Fake.Id, Previous = PieceType.EXT_C6.Id, Amount = 3});
        dict.Add(PieceType.EXT_C8Fake.Id, new PieceMatchDef {Next = PieceType.EXT_C8.Id, Previous = PieceType.EXT_C7.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_C8.Id, new PieceMatchDef {Next = PieceType.EXT_CMFake.Id, Previous = PieceType.EXT_C7.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.EXT_CMFake.Id, PieceType.EXT_CM.Id, PieceType.EXT_C8.Id);
        
        dict.Add(PieceType.EXT_CM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.EXT_C8.Id});
        
        #endregion
        
        #region EXT_D
        
        dict.Add(PieceType.EXT_D1.Id, new PieceMatchDef {Next = PieceType.EXT_D2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.EXT_D2.Id, new PieceMatchDef {Next = PieceType.EXT_D3Fake.Id, Previous = PieceType.EXT_D1.Id, Amount = 3});
        dict.Add(PieceType.EXT_D3Fake.Id, new PieceMatchDef {Next = PieceType.EXT_D3.Id, Previous = PieceType.EXT_D2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_D3.Id, new PieceMatchDef {Next = PieceType.EXT_D4Fake.Id, Previous = PieceType.EXT_D2.Id, Amount = 3});
        dict.Add(PieceType.EXT_D4Fake.Id, new PieceMatchDef {Next = PieceType.EXT_D4.Id, Previous = PieceType.EXT_D3.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_D4.Id, new PieceMatchDef {Next = PieceType.EXT_D5Fake.Id, Previous = PieceType.EXT_D3.Id, Amount = 3});
        dict.Add(PieceType.EXT_D5Fake.Id, new PieceMatchDef {Next = PieceType.EXT_D5.Id, Previous = PieceType.EXT_D4.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_D5.Id, new PieceMatchDef {Next = PieceType.EXT_D6Fake.Id, Previous = PieceType.EXT_D4.Id, Amount = 3});
        dict.Add(PieceType.EXT_D6Fake.Id, new PieceMatchDef {Next = PieceType.EXT_D6.Id, Previous = PieceType.EXT_D5.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_D6.Id, new PieceMatchDef {Next = PieceType.EXT_D7Fake.Id, Previous = PieceType.EXT_D5.Id, Amount = 3});
        dict.Add(PieceType.EXT_D7Fake.Id, new PieceMatchDef {Next = PieceType.EXT_D7.Id, Previous = PieceType.EXT_D6.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_D7.Id, new PieceMatchDef {Next = PieceType.EXT_D8Fake.Id, Previous = PieceType.EXT_D6.Id, Amount = 3});
        dict.Add(PieceType.EXT_D8Fake.Id, new PieceMatchDef {Next = PieceType.EXT_D8.Id, Previous = PieceType.EXT_D7.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_D8.Id, new PieceMatchDef {Next = PieceType.EXT_DMFake.Id, Previous = PieceType.EXT_D7.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.EXT_DMFake.Id, PieceType.EXT_DM.Id, PieceType.EXT_D8.Id);
        
        dict.Add(PieceType.EXT_DM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.EXT_D8.Id});
        
        #endregion
        
        #region EXT_E
        
        dict.Add(PieceType.EXT_E1.Id, new PieceMatchDef {Next = PieceType.EXT_E2.Id, Previous = PieceType.None.Id, Amount = 3});
        dict.Add(PieceType.EXT_E2.Id, new PieceMatchDef {Next = PieceType.EXT_E3Fake.Id, Previous = PieceType.EXT_E1.Id, Amount = 3});
        dict.Add(PieceType.EXT_E3Fake.Id, new PieceMatchDef {Next = PieceType.EXT_E3.Id, Previous = PieceType.EXT_E2.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_E3.Id, new PieceMatchDef {Next = PieceType.EXT_E4Fake.Id, Previous = PieceType.EXT_E2.Id, Amount = 3});
        dict.Add(PieceType.EXT_E4Fake.Id, new PieceMatchDef {Next = PieceType.EXT_E4.Id, Previous = PieceType.EXT_E3.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_E4.Id, new PieceMatchDef {Next = PieceType.EXT_E5Fake.Id, Previous = PieceType.EXT_E3.Id, Amount = 3});
        dict.Add(PieceType.EXT_E5Fake.Id, new PieceMatchDef {Next = PieceType.EXT_E5.Id, Previous = PieceType.EXT_E4.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_E5.Id, new PieceMatchDef {Next = PieceType.EXT_E6Fake.Id, Previous = PieceType.EXT_E4.Id, Amount = 3});
        dict.Add(PieceType.EXT_E6Fake.Id, new PieceMatchDef {Next = PieceType.EXT_E6.Id, Previous = PieceType.EXT_E5.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_E6.Id, new PieceMatchDef {Next = PieceType.EXT_E7Fake.Id, Previous = PieceType.EXT_E5.Id, Amount = 3});
        dict.Add(PieceType.EXT_E7Fake.Id, new PieceMatchDef {Next = PieceType.EXT_E7.Id, Previous = PieceType.EXT_E6.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_E7.Id, new PieceMatchDef {Next = PieceType.EXT_E8Fake.Id, Previous = PieceType.EXT_E6.Id, Amount = 3});
        dict.Add(PieceType.EXT_E8Fake.Id, new PieceMatchDef {Next = PieceType.EXT_E8.Id, Previous = PieceType.EXT_E7.Id, Amount = 1, IsIgnore = true});
        dict.Add(PieceType.EXT_E8.Id, new PieceMatchDef {Next = PieceType.EXT_EMFake.Id, Previous = PieceType.EXT_E7.Id, Amount = 3});
        
        dict = AddFakeMulticellularPiece(dict, PieceType.EXT_EMFake.Id, PieceType.EXT_EM.Id, PieceType.EXT_E8.Id);
        
        dict.Add(PieceType.EXT_EM.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.EXT_E8.Id});
