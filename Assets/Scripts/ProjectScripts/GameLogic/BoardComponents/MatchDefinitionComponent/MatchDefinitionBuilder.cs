...
public class MatchDefinitionBuilder
{
    ...
    private Dictionary<int, PieceMatchDef> AddPiece(Dictionary<int, PieceMatchDef> dict)
    {
        ...
        dict.Add(PieceType.D3.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.D2.Id, Count = 3});
        ...
        dict.Add(PieceType.E3.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.E2.Id, Count = 3});
        ...
        dict.Add(PieceType.G3.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.G2.Id, Count = 3});
        ...
        dict.Add(PieceType.H3.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.H2.Id, Count = 3});
        ...
        dict.Add(PieceType.I3.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.I2.Id, Count = 3});
        ...
        dict.Add(PieceType.J3.Id, new PieceMatchDef {Next = PieceType.None.Id, Previous = PieceType.J2.Id, Count = 3});
