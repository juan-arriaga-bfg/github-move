...
public static partial class PieceType 
{
    ...
    public static readonly PieceTypeDef MineX = new PieceTypeDef{Id = 10002, Abbreviations = new List<string>{ "MineX" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Mine};
