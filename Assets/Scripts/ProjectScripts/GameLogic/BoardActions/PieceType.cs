...
public static partial class PieceType 
{
    ...
    public static readonly PieceTypeDef Hero1 = new PieceTypeDef{Id = 10, Abbreviations = new List<string>{ "Hero1" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Hero};
