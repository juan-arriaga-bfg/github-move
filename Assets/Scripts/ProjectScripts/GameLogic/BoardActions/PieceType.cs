...
public static partial class PieceType 
{
    ...
    public static readonly PieceTypeDef A3Fake = new PieceTypeDef{Id = 102, Abbreviations = new List<string>{ "A3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef A4Fake = new PieceTypeDef{Id = 104, Abbreviations = new List<string>{ "A4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef A5Fake = new PieceTypeDef{Id = 106, Abbreviations = new List<string>{ "A5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef A6Fake = new PieceTypeDef{Id = 108, Abbreviations = new List<string>{ "A6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef A7Fake = new PieceTypeDef{Id = 110, Abbreviations = new List<string>{ "A7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef A8Fake = new PieceTypeDef{Id = 112, Abbreviations = new List<string>{ "A8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef A8 = new PieceTypeDef{Id = 113, Abbreviations = new List<string>{ "A8" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef A9Fake = new PieceTypeDef{Id = 114, Abbreviations = new List<string>{ "A9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef A9 = new PieceTypeDef{Id = 115, Abbreviations = new List<string>{ "A9" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C3Fake = new PieceTypeDef{Id = 302, Abbreviations = new List<string>{ "C3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C4Fake = new PieceTypeDef{Id = 304, Abbreviations = new List<string>{ "C4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C5Fake = new PieceTypeDef{Id = 306, Abbreviations = new List<string>{ "C5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C6Fake = new PieceTypeDef{Id = 308, Abbreviations = new List<string>{ "C6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C7Fake = new PieceTypeDef{Id = 310, Abbreviations = new List<string>{ "C7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C8Fake = new PieceTypeDef{Id = 312, Abbreviations = new List<string>{ "C8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C9Fake = new PieceTypeDef{Id = 314, Abbreviations = new List<string>{ "C9Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef C10Fake = new PieceTypeDef{Id = 316, Abbreviations = new List<string>{ "C10Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef C10 = new PieceTypeDef{Id = 317, Abbreviations = new List<string>{ "C10" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef C11Fake = new PieceTypeDef{Id = 318, Abbreviations = new List<string>{ "C11Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef C11 = new PieceTypeDef{Id = 319, Abbreviations = new List<string>{ "C11" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K3Fake = new PieceTypeDef{Id = 1102, Abbreviations = new List<string>{ "K3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K4Fake = new PieceTypeDef{Id = 1104, Abbreviations = new List<string>{ "K4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K5Fake = new PieceTypeDef{Id = 1106, Abbreviations = new List<string>{ "K5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K6Fake = new PieceTypeDef{Id = 1108, Abbreviations = new List<string>{ "K6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K7Fake = new PieceTypeDef{Id = 1110, Abbreviations = new List<string>{ "K7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K8Fake = new PieceTypeDef{Id = 1112, Abbreviations = new List<string>{ "K8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef K9Fake = new PieceTypeDef{Id = 1114, Abbreviations = new List<string>{ "K9Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef K9 = new PieceTypeDef{Id = 1115, Abbreviations = new List<string>{ "K9" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef K10Fake = new PieceTypeDef{Id = 1116, Abbreviations = new List<string>{ "K10Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef K10 = new PieceTypeDef{Id = 1117, Abbreviations = new List<string>{ "K10" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef L3Fake = new PieceTypeDef{Id = 1202, Abbreviations = new List<string>{ "L3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef L4Fake = new PieceTypeDef{Id = 1204, Abbreviations = new List<string>{ "L4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef L5Fake = new PieceTypeDef{Id = 1206, Abbreviations = new List<string>{ "L5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef L6Fake = new PieceTypeDef{Id = 1208, Abbreviations = new List<string>{ "L6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef L7Fake = new PieceTypeDef{Id = 1210, Abbreviations = new List<string>{ "L7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef L8Fake = new PieceTypeDef{Id = 1212, Abbreviations = new List<string>{ "L8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef L8 = new PieceTypeDef{Id = 1213, Abbreviations = new List<string>{ "L8" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef L9Fake = new PieceTypeDef{Id = 1214, Abbreviations = new List<string>{ "L9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef L9 = new PieceTypeDef{Id = 1215, Abbreviations = new List<string>{ "L9" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef D4 = new PieceTypeDef{Id = 403, Abbreviations = new List<string>{ "D4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef E4 = new PieceTypeDef{Id = 503, Abbreviations = new List<string>{ "E4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef F4 = new PieceTypeDef{Id = 603, Abbreviations = new List<string>{ "F4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef G4 = new PieceTypeDef{Id = 703, Abbreviations = new List<string>{ "G4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef H4 = new PieceTypeDef{Id = 803, Abbreviations = new List<string>{ "H4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef I4 = new PieceTypeDef{Id = 903, Abbreviations = new List<string>{ "I4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef J4 = new PieceTypeDef{Id = 1003, Abbreviations = new List<string>{ "J4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.WorkPlace};
    ...
    public static readonly PieceTypeDef O1 = new PieceTypeDef{Id = 2100, Abbreviations = new List<string>{ "O1" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O2 = new PieceTypeDef{Id = 2101, Abbreviations = new List<string>{ "O2" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O3 = new PieceTypeDef{Id = 2102, Abbreviations = new List<string>{ "O3" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O4 = new PieceTypeDef{Id = 2103, Abbreviations = new List<string>{ "O4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O5 = new PieceTypeDef{Id = 2104, Abbreviations = new List<string>{ "O5" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O6 = new PieceTypeDef{Id = 2105, Abbreviations = new List<string>{ "O6" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O7 = new PieceTypeDef{Id = 2106, Abbreviations = new List<string>{ "O7" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O8 = new PieceTypeDef{Id = 2107, Abbreviations = new List<string>{ "O8" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    public static readonly PieceTypeDef O9 = new PieceTypeDef{Id = 2108, Abbreviations = new List<string>{ "O9" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace | PieceTypeFilter.Tree};
    
    public static readonly PieceTypeDef OX1 = new PieceTypeDef{Id = 2200, Abbreviations = new List<string>{ "OX1" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX2 = new PieceTypeDef{Id = 2201, Abbreviations = new List<string>{ "OX2" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX3 = new PieceTypeDef{Id = 2202, Abbreviations = new List<string>{ "OX3" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX4 = new PieceTypeDef{Id = 2203, Abbreviations = new List<string>{ "OX4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX5 = new PieceTypeDef{Id = 2204, Abbreviations = new List<string>{ "OX5" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX6 = new PieceTypeDef{Id = 2205, Abbreviations = new List<string>{ "OX6" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX7 = new PieceTypeDef{Id = 2206, Abbreviations = new List<string>{ "OX7" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX8 = new PieceTypeDef{Id = 2207, Abbreviations = new List<string>{ "OX8" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OX9 = new PieceTypeDef{Id = 2208, Abbreviations = new List<string>{ "OX9" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    
    public static readonly PieceTypeDef OEpic1 = new PieceTypeDef{Id = 2300, Abbreviations = new List<string>{ "OEpic1" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic2 = new PieceTypeDef{Id = 2301, Abbreviations = new List<string>{ "OEpic2" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic3 = new PieceTypeDef{Id = 2302, Abbreviations = new List<string>{ "OEpic3" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic4 = new PieceTypeDef{Id = 2303, Abbreviations = new List<string>{ "OEpic4" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic5 = new PieceTypeDef{Id = 2304, Abbreviations = new List<string>{ "OEpic5" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic6 = new PieceTypeDef{Id = 2305, Abbreviations = new List<string>{ "OEpic6" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic7 = new PieceTypeDef{Id = 2306, Abbreviations = new List<string>{ "OEpic7" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic8 = new PieceTypeDef{Id = 2307, Abbreviations = new List<string>{ "OEpic8" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef OEpic9 = new PieceTypeDef{Id = 2308, Abbreviations = new List<string>{ "OEpic9" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    
    public static readonly PieceTypeDef ObstacleD = new PieceTypeDef{Id = 2400, Abbreviations = new List<string>{ "ObstacleD" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef ObstacleE = new PieceTypeDef{Id = 2401, Abbreviations = new List<string>{ "ObstacleE" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef ObstacleF = new PieceTypeDef{Id = 2402, Abbreviations = new List<string>{ "ObstacleF" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef ObstacleG = new PieceTypeDef{Id = 2403, Abbreviations = new List<string>{ "ObstacleG" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    public static readonly PieceTypeDef ObstacleH = new PieceTypeDef{Id = 2404, Abbreviations = new List<string>{ "ObstacleH" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Obstacle | PieceTypeFilter.WorkPlace};
    
    public static readonly PieceTypeDef Worker1 = new PieceTypeDef{Id = 3000, Abbreviations = new List<string>{ "Worker1" }, Filter = PieceTypeFilter.Simple};
