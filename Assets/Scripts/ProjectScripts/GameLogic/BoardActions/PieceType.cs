...
#region Character pieces
    ...
    public static readonly PieceTypeDef NPC_Z8 = new PieceTypeDef{Id = 302507, Abbreviations = new List<string>{ "NPC_Z8" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Progress};
...
#region Mines
    ...
    public static readonly PieceTypeDef MN_B4Fake = new PieceTypeDef{Id = 5016, Abbreviations = new List<string>{ "MN_B4Fake" },         Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Mine | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
...
#region Reproduction Pieces
    ...
    public static readonly PieceTypeDef PR_Z5 = new PieceTypeDef{Id = 202504, Abbreviations = new List<string>{ "PR_Z5" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Resource | PieceTypeFilter.Ingredient};
    
#endregion
    
#region Orders
    
    public static readonly PieceTypeDef RC_A = new PieceTypeDef{Id = 400010, Abbreviations = new List<string>{ "RC_A" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_B = new PieceTypeDef{Id = 400020, Abbreviations = new List<string>{ "RC_B" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_C = new PieceTypeDef{Id = 400030, Abbreviations = new List<string>{ "RC_C" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_D = new PieceTypeDef{Id = 400040, Abbreviations = new List<string>{ "RC_D" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_E = new PieceTypeDef{Id = 400050, Abbreviations = new List<string>{ "RC_E" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_F = new PieceTypeDef{Id = 400060, Abbreviations = new List<string>{ "RC_F" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_G = new PieceTypeDef{Id = 400070, Abbreviations = new List<string>{ "RC_G" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_H = new PieceTypeDef{Id = 400080, Abbreviations = new List<string>{ "RC_H" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_I = new PieceTypeDef{Id = 400090, Abbreviations = new List<string>{ "RC_I" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_J = new PieceTypeDef{Id = 400100, Abbreviations = new List<string>{ "RC_J" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_K = new PieceTypeDef{Id = 400110, Abbreviations = new List<string>{ "RC_K" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_L = new PieceTypeDef{Id = 400120, Abbreviations = new List<string>{ "RC_L" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_M = new PieceTypeDef{Id = 400130, Abbreviations = new List<string>{ "RC_M" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_N = new PieceTypeDef{Id = 400140, Abbreviations = new List<string>{ "RC_N" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_O = new PieceTypeDef{Id = 400150, Abbreviations = new List<string>{ "RC_O" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_P = new PieceTypeDef{Id = 400160, Abbreviations = new List<string>{ "RC_P" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_Q = new PieceTypeDef{Id = 400170, Abbreviations = new List<string>{ "RC_Q" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_R = new PieceTypeDef{Id = 400180, Abbreviations = new List<string>{ "RC_R" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_S = new PieceTypeDef{Id = 400190, Abbreviations = new List<string>{ "RC_S" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_T = new PieceTypeDef{Id = 400200, Abbreviations = new List<string>{ "RC_T" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_U = new PieceTypeDef{Id = 400210, Abbreviations = new List<string>{ "RC_U" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_V = new PieceTypeDef{Id = 400220, Abbreviations = new List<string>{ "RC_V" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
    public static readonly PieceTypeDef RC_W = new PieceTypeDef{Id = 400230, Abbreviations = new List<string>{ "RC_W" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.OrderPiece};
...
#region Extended Pieces
    ...
    public static readonly PieceTypeDef EXT_A1     = new PieceTypeDef{Id = 500000, Abbreviations = new List<string>{ "EXT_A1" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_A2     = new PieceTypeDef{Id = 500001, Abbreviations = new List<string>{ "EXT_A2" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_A3Fake = new PieceTypeDef{Id = 500002, Abbreviations = new List<string>{ "EXT_A3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A3     = new PieceTypeDef{Id = 500003, Abbreviations = new List<string>{ "EXT_A3" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_A4Fake = new PieceTypeDef{Id = 500004, Abbreviations = new List<string>{ "EXT_A4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A4     = new PieceTypeDef{Id = 500005, Abbreviations = new List<string>{ "EXT_A4" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_A5Fake = new PieceTypeDef{Id = 500006, Abbreviations = new List<string>{ "EXT_A5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A5     = new PieceTypeDef{Id = 500007, Abbreviations = new List<string>{ "EXT_A5" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_A6Fake = new PieceTypeDef{Id = 500008, Abbreviations = new List<string>{ "EXT_A6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A6     = new PieceTypeDef{Id = 500009, Abbreviations = new List<string>{ "EXT_A6" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_A7Fake = new PieceTypeDef{Id = 500010, Abbreviations = new List<string>{ "EXT_A7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A7     = new PieceTypeDef{Id = 500011, Abbreviations = new List<string>{ "EXT_A7" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_A8Fake = new PieceTypeDef{Id = 500012, Abbreviations = new List<string>{ "EXT_A8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A8     = new PieceTypeDef{Id = 500013, Abbreviations = new List<string>{ "EXT_A8" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A9Fake = new PieceTypeDef{Id = 500014, Abbreviations = new List<string>{ "EXT_A9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_A9     = new PieceTypeDef{Id = 500015, Abbreviations = new List<string>{ "EXT_A9" },     Filter = PieceTypeFilter.Multicellular};
    
    #endregion

    #region EXT_B
    
    public static readonly PieceTypeDef EXT_B1     = new PieceTypeDef{Id = 500100, Abbreviations = new List<string>{ "EXT_B1" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_B2     = new PieceTypeDef{Id = 500101, Abbreviations = new List<string>{ "EXT_B2" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_B3Fake = new PieceTypeDef{Id = 500102, Abbreviations = new List<string>{ "EXT_B3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B3     = new PieceTypeDef{Id = 500103, Abbreviations = new List<string>{ "EXT_B3" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_B4Fake = new PieceTypeDef{Id = 500104, Abbreviations = new List<string>{ "EXT_B4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B4     = new PieceTypeDef{Id = 500105, Abbreviations = new List<string>{ "EXT_B4" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_B5Fake = new PieceTypeDef{Id = 500106, Abbreviations = new List<string>{ "EXT_B5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B5     = new PieceTypeDef{Id = 500107, Abbreviations = new List<string>{ "EXT_B5" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_B6Fake = new PieceTypeDef{Id = 500108, Abbreviations = new List<string>{ "EXT_B6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B6     = new PieceTypeDef{Id = 500109, Abbreviations = new List<string>{ "EXT_B6" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_B7Fake = new PieceTypeDef{Id = 500110, Abbreviations = new List<string>{ "EXT_B7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B7     = new PieceTypeDef{Id = 500111, Abbreviations = new List<string>{ "EXT_B7" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_B8Fake = new PieceTypeDef{Id = 500112, Abbreviations = new List<string>{ "EXT_B8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B8     = new PieceTypeDef{Id = 500113, Abbreviations = new List<string>{ "EXT_B8" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B9Fake = new PieceTypeDef{Id = 500114, Abbreviations = new List<string>{ "EXT_B9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_B9     = new PieceTypeDef{Id = 500115, Abbreviations = new List<string>{ "EXT_B9" },     Filter = PieceTypeFilter.Multicellular};
    
    #endregion

    #region EXT_C
    
    public static readonly PieceTypeDef EXT_C1     = new PieceTypeDef{Id = 500200, Abbreviations = new List<string>{ "EXT_C1" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_C2     = new PieceTypeDef{Id = 500201, Abbreviations = new List<string>{ "EXT_C2" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_C3Fake = new PieceTypeDef{Id = 500202, Abbreviations = new List<string>{ "EXT_C3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C3     = new PieceTypeDef{Id = 500203, Abbreviations = new List<string>{ "EXT_C3" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_C4Fake = new PieceTypeDef{Id = 500204, Abbreviations = new List<string>{ "EXT_C4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C4     = new PieceTypeDef{Id = 500205, Abbreviations = new List<string>{ "EXT_C4" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_C5Fake = new PieceTypeDef{Id = 500206, Abbreviations = new List<string>{ "EXT_C5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C5     = new PieceTypeDef{Id = 500207, Abbreviations = new List<string>{ "EXT_C5" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_C6Fake = new PieceTypeDef{Id = 500208, Abbreviations = new List<string>{ "EXT_C6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C6     = new PieceTypeDef{Id = 500209, Abbreviations = new List<string>{ "EXT_C6" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_C7Fake = new PieceTypeDef{Id = 500210, Abbreviations = new List<string>{ "EXT_C7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C7     = new PieceTypeDef{Id = 500211, Abbreviations = new List<string>{ "EXT_C7" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_C8Fake = new PieceTypeDef{Id = 500212, Abbreviations = new List<string>{ "EXT_C8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C8     = new PieceTypeDef{Id = 500213, Abbreviations = new List<string>{ "EXT_C8" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C9Fake = new PieceTypeDef{Id = 500214, Abbreviations = new List<string>{ "EXT_C9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_C9     = new PieceTypeDef{Id = 500215, Abbreviations = new List<string>{ "EXT_C9" },     Filter = PieceTypeFilter.Multicellular};
    
    #endregion

    #region EXT_D
    
    public static readonly PieceTypeDef EXT_D1     = new PieceTypeDef{Id = 500300, Abbreviations = new List<string>{ "EXT_D1" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_D2     = new PieceTypeDef{Id = 500301, Abbreviations = new List<string>{ "EXT_D2" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_D3Fake = new PieceTypeDef{Id = 500302, Abbreviations = new List<string>{ "EXT_D3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D3     = new PieceTypeDef{Id = 500303, Abbreviations = new List<string>{ "EXT_D3" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_D4Fake = new PieceTypeDef{Id = 500304, Abbreviations = new List<string>{ "EXT_D4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D4     = new PieceTypeDef{Id = 500305, Abbreviations = new List<string>{ "EXT_D4" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_D5Fake = new PieceTypeDef{Id = 500306, Abbreviations = new List<string>{ "EXT_D5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D5     = new PieceTypeDef{Id = 500307, Abbreviations = new List<string>{ "EXT_D5" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_D6Fake = new PieceTypeDef{Id = 500308, Abbreviations = new List<string>{ "EXT_D6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D6     = new PieceTypeDef{Id = 500309, Abbreviations = new List<string>{ "EXT_D6" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_D7Fake = new PieceTypeDef{Id = 500310, Abbreviations = new List<string>{ "EXT_D7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D7     = new PieceTypeDef{Id = 500311, Abbreviations = new List<string>{ "EXT_D7" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_D8Fake = new PieceTypeDef{Id = 500312, Abbreviations = new List<string>{ "EXT_D8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D8     = new PieceTypeDef{Id = 500313, Abbreviations = new List<string>{ "EXT_D8" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D9Fake = new PieceTypeDef{Id = 500314, Abbreviations = new List<string>{ "EXT_D9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_D9     = new PieceTypeDef{Id = 500315, Abbreviations = new List<string>{ "EXT_D9" },     Filter = PieceTypeFilter.Multicellular};
    
    #endregion

    #region EXT_E
    
    public static readonly PieceTypeDef EXT_E1     = new PieceTypeDef{Id = 500400, Abbreviations = new List<string>{ "EXT_E1" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_E2     = new PieceTypeDef{Id = 500401, Abbreviations = new List<string>{ "EXT_E2" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Removable};
    public static readonly PieceTypeDef EXT_E3Fake = new PieceTypeDef{Id = 500402, Abbreviations = new List<string>{ "EXT_E3Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E3     = new PieceTypeDef{Id = 500403, Abbreviations = new List<string>{ "EXT_E3" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_E4Fake = new PieceTypeDef{Id = 500404, Abbreviations = new List<string>{ "EXT_E4Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E4     = new PieceTypeDef{Id = 500405, Abbreviations = new List<string>{ "EXT_E4" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_E5Fake = new PieceTypeDef{Id = 500406, Abbreviations = new List<string>{ "EXT_E5Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E5     = new PieceTypeDef{Id = 500407, Abbreviations = new List<string>{ "EXT_E5" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_E6Fake = new PieceTypeDef{Id = 500408, Abbreviations = new List<string>{ "EXT_E6Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E6     = new PieceTypeDef{Id = 500409, Abbreviations = new List<string>{ "EXT_E6" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_E7Fake = new PieceTypeDef{Id = 500410, Abbreviations = new List<string>{ "EXT_E7Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E7     = new PieceTypeDef{Id = 500411, Abbreviations = new List<string>{ "EXT_E7" },     Filter = PieceTypeFilter.Simple};
    public static readonly PieceTypeDef EXT_E8Fake = new PieceTypeDef{Id = 500412, Abbreviations = new List<string>{ "EXT_E8Fake" }, Filter = PieceTypeFilter.Simple | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E8     = new PieceTypeDef{Id = 500413, Abbreviations = new List<string>{ "EXT_E8" },     Filter = PieceTypeFilter.Simple | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E9Fake = new PieceTypeDef{Id = 500414, Abbreviations = new List<string>{ "EXT_E9Fake" }, Filter = PieceTypeFilter.Multicellular | PieceTypeFilter.Fake | PieceTypeFilter.Workplace};
    public static readonly PieceTypeDef EXT_E9     = new PieceTypeDef{Id = 500415, Abbreviations = new List<string>{ "EXT_E9" },     Filter = PieceTypeFilter.Multicellular};
    
    #endregion
    
    public static readonly PieceTypeDef EXT_Z9     = new PieceTypeDef{Id = 502515, Abbreviations = new List<string>{ "EXT_Z9" },     Filter = PieceTypeFilter.Multicellular};
