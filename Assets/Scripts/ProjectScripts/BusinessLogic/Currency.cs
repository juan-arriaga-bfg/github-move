public static partial class Currency
{
    ...
    public static readonly CurrencyDef PieceA1 = new CurrencyDef { Id = 6, Name = "PieceA1", IsConsumable = true };
    public static readonly CurrencyDef PieceA2 = new CurrencyDef { Id = 7, Name = "PieceA2", IsConsumable = true };
    public static readonly CurrencyDef PieceA3 = new CurrencyDef { Id = 8, Name = "PieceA3", IsConsumable = true };
    public static readonly CurrencyDef PieceA4 = new CurrencyDef { Id = 9, Name = "PieceA4", IsConsumable = true };
    public static readonly CurrencyDef PieceA5 = new CurrencyDef { Id = 10, Name = "PieceA5", IsConsumable = true };
    public static readonly CurrencyDef PieceA6 = new CurrencyDef { Id = 11, Name = "PieceA6", IsConsumable = true };
    public static readonly CurrencyDef PieceA7 = new CurrencyDef { Id = 12, Name = "PieceA7", IsConsumable = true };
    
    public static readonly CurrencyDef PieceB1 = new CurrencyDef { Id = 13, Name = "PieceB1", IsConsumable = true };
    public static readonly CurrencyDef PieceB2 = new CurrencyDef { Id = 14, Name = "PieceB2", IsConsumable = true };
    public static readonly CurrencyDef PieceB3 = new CurrencyDef { Id = 15, Name = "PieceB3", IsConsumable = true };
    public static readonly CurrencyDef PieceB4 = new CurrencyDef { Id = 16, Name = "PieceB4", IsConsumable = true };
    public static readonly CurrencyDef PieceB5 = new CurrencyDef { Id = 17, Name = "PieceB5", IsConsumable = true };
