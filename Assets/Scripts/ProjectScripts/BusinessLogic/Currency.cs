public static partial class Currency
{
    ...
    public static readonly CurrencyDef Chest = new CurrencyDef { Id = 6, Name = "Chest", IsConsumable = true };
    
    public static readonly CurrencyDef PieceA1 = new CurrencyDef { Id = 7, Name = "PieceA1", IsConsumable = true };
    public static readonly CurrencyDef PieceA2 = new CurrencyDef { Id = 8, Name = "PieceA2", IsConsumable = true };
    public static readonly CurrencyDef PieceA3 = new CurrencyDef { Id = 9, Name = "PieceA3", IsConsumable = true };
    public static readonly CurrencyDef PieceB1 = new CurrencyDef { Id = 10, Name = "PieceB1", IsConsumable = true };
    public static readonly CurrencyDef PieceB2 = new CurrencyDef { Id = 11, Name = "PieceB2", IsConsumable = true };
    public static readonly CurrencyDef PieceB3 = new CurrencyDef { Id = 12, Name = "PieceB3", IsConsumable = true };
    
    public static readonly CurrencyDef LevelRobin = new CurrencyDef { Id = 13, Name = "LevelRobin", IsConsumable = true };
