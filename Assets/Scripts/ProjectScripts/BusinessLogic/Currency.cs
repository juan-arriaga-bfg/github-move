...
{
    public static readonly CurrencyDef Crystals = new CurrencyDef { Id = 20, Name = "Crystals", IsConsumable = true };
    public static readonly CurrencyDef Mana = new CurrencyDef { Id = 30, Name = "Mana", IsConsumable = true };
    
    public static readonly CurrencyDef Energy = new CurrencyDef { Id = 40, Name = "Energy", IsConsumable = true };
    public static readonly CurrencyDef EnergyLimit = new CurrencyDef { Id = 41, Name = "EnergyLimit", IsConsumable = true };
    
    public static readonly CurrencyDef Worker = new CurrencyDef { Id = 50, Name = "Worker", IsConsumable = true };
    public static readonly CurrencyDef WorkerLimit = new CurrencyDef { Id = 51, Name = "WorkerLimit", IsConsumable = true };
    
    public static readonly CurrencyDef Level = new CurrencyDef { Id = 60, Name = "Level", IsConsumable = true };
    public static readonly CurrencyDef Experience = new CurrencyDef { Id = 61, Name = "Experience", IsConsumable = true };
