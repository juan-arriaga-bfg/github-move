...
public class UIHintArrowComponent : ECSEntity
{
    ...
    public UIHintArrowViewController ShowArrow(Transform anchor, float lifetime = 3f, Vector3 offset = default(Vector3), Vector3 rotation = default(Vector3))
    {
        return ShowArrow(anchor, offset, rotation, Vector3.one, lifetime, true);
    }
