...
/**
 *  Filters for external contacts fetching
 */
typedef NS_ENUM(NSInteger, RaveContactsFilter){
    /**
     *  Include all external contacts
     */
    RaveContactsFilterIncludeAll,
    /**
     *  Include only external contacts using this app
     */
    RaveContactsFilterIncludeOnlyUsingApp,
    /**
     *  Exclude external contacts using this app
     */
    RaveContactsFilterExcludeUsingApp,
};

/**
 *  Manager for RaveContacts
 */
@protocol RaveContactsManager <RaveObject>
/**
 *  getContactByRaveId
 *
