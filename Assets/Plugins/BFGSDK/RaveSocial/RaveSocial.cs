...
namespace RAVESDK
{
...
#if UNITY_ANDROID
                new AndroidJavaClass("com.bigfishgames.bfgunityandroid.CustomRaveSocialStatics").CallStatic("RaveSocialOnStart");
#endif
        }
...
#if UNITY_ANDROID
                new AndroidJavaClass("com.bigfishgames.bfgunityandroid.CustomRaveSocialStatics").CallStatic("RaveSocialOnStop");
#endif
        }
	...
	public static bool RaveSocialIsInitialized() {
		AndroidJavaClass rsClass = new AndroidJavaClass("com.bigfishgames.bfgunityandroid.CustomRaveSocialStatics");
